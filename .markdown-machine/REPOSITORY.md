---
{
  ...
  "remote_name": "origin",
  "persistence_ref": "refs/heads/codex/manna-v1-product-discovery",
...
| default branch | `main` |
| governed persistence ref | `refs/heads/codex/manna-v1-product-discovery` |
...
Remote currentness is established by authoritative Git ref readback (`git ls-remote` or an equivalent GitHub ref observation) for the exact governed ref. The earlier governance-reconciliation ref remains historical continuity; the current bounded transaction persists on the non-default discovery branch `codex/manna-v1-product-discovery`.
