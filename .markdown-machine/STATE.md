---
{
  ...
  "lifecycle_revision": "manna-v1-product-discovery",
  "run_horizon": "complete the UI/UX interview, verify the design, and obtain explicit Product Freeze before implementation",
  "active_capabilities": ["software-product"],
  "repository_sync": "REPOSITORY_SYNCED",
  "work_status": "UI_UX_INTERVIEW_PENDING"
}
---
...
The accepted Version 1 product interview is now canonical in `docs/01-spec/manna-v1-product-contract.md` and `intent/PRODUCT-CONTRACT-V1.md`. It changes the product frontier: P0.1 remains feasibility evidence, while the next legal step is UI/UX interview and design verification. The roadmap must be recompiled after Product Freeze because Version 1 now brings module/document import and Verse Finder forward.
