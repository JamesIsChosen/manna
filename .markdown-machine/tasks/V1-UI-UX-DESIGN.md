---
{
  ...
  "status": "FLOW_DRAFT_AWAITING_HUMAN_APPROVAL",
...
The low-fidelity flow and edge-state draft is recorded in
`docs/01-spec/design-reference/manna-v1-low-fidelity-flows.md`. The immediate
next step is human review and approval of that draft. After approval, verify the
visual system and high-fidelity interactive desktop/phone mock, demonstrating
capability coverage, responsive behavior, accessibility, edge states, and exact
